...
conf.wisp_red_damage_replication_factor = 0.3
conf.wisp_red_damage_replication_tbf = '4/60:50'
conf.wisp_red_damage_replication_tbf_fallback = conf.wisp_red_damage_replication_tbf
