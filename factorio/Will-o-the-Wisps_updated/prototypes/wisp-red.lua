data:extend({
{
		...
		{
			{
				filename = '__Will-o-the-Wisps_updated__/sound/wisp-5.ogg',
				volume = 0.4
			},
			{
				filename = '__Will-o-the-Wisps_updated__/sound/wisp-6.ogg',
				volume = 0.3
			}
		},
		attack_parameters =
		...
		animation =
		{
			...
			{
				{
					filename = '__Will-o-the-Wisps_updated__/graphics/entity/wisp-red/wisp-red-attack.png',
					priority = 'high',
					width = 158,
					height = 158,
					frame_count = 2,
	...
	attack_reaction =
	{
		...
		run_animation = {
			...
			{
				{
					filename = '__Will-o-the-Wisps_updated__/graphics/entity/wisp-red/wisp-red.png',
					priority = 'high',
					width = 158,
					height = 158,
					frame_count = 2,
