--- Source: https://github.com/Afforess/Factorio-Stdlib/blob/master/stdlib/log/logger.lua
--- Docs: https://afforess.github.io/Factorio-Stdlib/modules/log.html
--- License: ISC
...
local function fail_if_missing(var, msg)
	if not var then error(msg or "Missing value", 3) end
	return false
end
