...
This mod allows to prohibit that anywhere in the empire or on a specific planet by toggling an edict there.
...
[h1]Available sector development policies / edicts[/h1]
...
Yup, just one so far, but will probably add more if anything else will be annoying enough.
